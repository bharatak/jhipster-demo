...
import com.thoughtworks.bank.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.thoughtworks.bank.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "bankEmployee";
