...
import com.thoughtworks.bank.domain.Job;
import com.thoughtworks.bank.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.thoughtworks.bank.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "bankJob";
