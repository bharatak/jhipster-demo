...
import com.thoughtworks.bank.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.thoughtworks.bank.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "bankJobHistory";
